...
List<CategoryModel> demoCategories = [
  ...
  CategoryModel(name: "Konsumsi"),
  CategoryModel(name: "Kurban"),
  CategoryModel(name: "Akikah"),
];
// End For Preview
            ...
            (index) => Padding(
              ...
              child: Obx(
                () => CategoryBtn(
                  ...
                  isActive: produkController.indexKategori.value == index,
                  press: () {
                    produkController.kategori.value =
                        demoCategories[index].name;
                    produkController.indexKategori.value = index;
                  },
                ),
              ),
            ),
