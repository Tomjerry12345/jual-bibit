...
class FirebaseServices {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> onSearching(
          String collection, String query, dynamic search) =>
      _db
          .collection(collection)
          .where(query, isGreaterThanOrEqualTo: search)
          .where(query, isLessThanOrEqualTo: search + '\uf8ff')
          .snapshots();
  ...
  Future<List<QueryDocumentSnapshot<Map<String, dynamic>>>>
      getDataCollection3ByQuery(String collection, String query, dynamic value,
          String query2, dynamic value2, String query3, dynamic value3) async {
    final data = await _db
        .collection(collection)
        .where(query, isEqualTo: value)
        .where(query2, isEqualTo: value2)
        .where(query3, isEqualTo: value3)
        .get();
  ...
  Future uploadFile(File file, String fileName, String type) async {
